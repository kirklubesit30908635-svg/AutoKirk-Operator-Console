...
const faces = [
  {
    ...
    desc: "Next Actions Â· Reassurance Search Â· Daily Check-In",
    href: "/tucker",
    status: "Operational",
    cta: "Enter Face",
  },
  {
    ...
    desc: "Stripe intake â†’ obligations â†’ closure â†’ receipts",
    href: "/billing-ops",
  ...
  },
  {
    ...
    desc: "Spend â†’ Lead â†’ Follow-Up â†’ Sale â†’ Margin â†’ Renewal Gate",
    href: "/advertising",
    status: "Operational",
    cta: "Enter Face",
  },
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-16">
        ...
        <section className="mt-8 max-w-3xl">
          ...
          <p className="mt-5 text-base leading-relaxed text-zinc-400">
            ...
            isnâ€™t written here, it didnâ€™t happen.
          </p>
        </section>
